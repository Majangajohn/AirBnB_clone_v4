...
|                                                      Parts                                                    |                    Description                    |
| :------------------------------------------------------------------------------------------------------------ | :-----------------------------------------------  |
| [1. Console](https://github.com/Majangajohn/AirBnB_clone)                                                  |   Data model management via command interpreter   |
| [2. Web static](https://github.com/Majangajohn/AirBnB_clone/tree/master/web_static)                        |             Landing page in HTML and CSS          |
| [3. MySQL storage](https://github.com/Majangajohn/AirBnB_clone_v2/blob/master/models/engine/db_storage.py) | Migration of local file storage to MySQL database |
| [4. Deploy static](https://github.com/Majangajohn/AirBnB_clone_v2/blob/master/3-deploy_web_static.py)      |        Deploy web static on an Nginx server       |
| [5. Web framework - templating](https://github.com/Majangajohn/AirBnB_clone_v2/tree/master/web_flask)      |         Web server deployment with Flask          |
| [6. RESTful API](https://github.com/Majangajohn/AirBnB_clone_v3/tree/master/api)                           |      Creating endpoints for CRUD operations       |
| [7. Web dynamic](https://github.com/Majangajohn/AirBnB_clone_v4/tree/master/web_dynamic)                   | Loading of objects from client side using Jquery  |
...
* **Majanga John** - [majangajohn](https://github.com/MajangaJohn) 
